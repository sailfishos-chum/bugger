    ...
    SilicaFlickable { id: flick
        ...
        Column { id: col
            ...
            Column {
                ...
                TextField{id: text_title; width: parent.width; placeholderText: "A New Bug Report"}
                SectionHeader { text: "Description" }
                TextArea{id: text_desc; width: parent.width; placeholderText: "Describe what is not working" }
            }
            Flow {
                width: parent.width
                Column {
            ...
            TextArea{id: text_prereq; width: parent.width; placeholderText: "Some Context information, e.g. 'an email account is needed'."}
            ...
            //TextArea{id: text_add; width: parent.width; placeholderText: ""}
            ...
            TextSwitch { id: regsw; checked: false; text: "Regression (compared to a previous OS release)" }
            Column {
                width: parent.width
