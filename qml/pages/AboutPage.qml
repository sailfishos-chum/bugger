  ...
  SilicaFlickable {
    ...
    Column {
        ...
        LinkedLabel {
            ...
            plainText: qsTr("%1 is a little tool to assist reporting bugs on https://forum.sailfishos.org, following a more or less standardized template.\nReporting bugs in this way should improve Jolla's ability to pick them up and track them internally. For more information, see %2").arg(qsTr(Qt.application.name)).arg(helpurl)
        }
